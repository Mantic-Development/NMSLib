...
public final class NMSLib_V1_21_R2 implements NMSHandler {

    public NMSLib_V1_21_R2() {
    ...
    public org.bukkit.enchantments.Enchantment buildEnchantment(EnchantInfo enchantInfo, Plugin plugin) {
        NamespacedKey key = new NamespacedKey(plugin, enchantInfo.getName().toLowerCase());
    ...
    public Enchantment registerEnchantment(EnchantInfo enchantInfo, Plugin plugin) {
        Enchantment enchantment = lookupEnchantment(enchantInfo.getName().toLowerCase(), enchantInfo.getInternalId());
        if (enchantment != null) {
            return enchantment;
        }
    ...
    public ItemStack addAttributes(Map<String, String> atttributes, ItemStack itemStack) {
        ItemMeta itemMeta = itemStack.getItemMeta();
        atttributes.forEach((s, s2) -> {
            Attribute attribute = Attribute.valueOf(s);
        });

        final ItemStack finalStack = itemStack.clone();
