...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        Skeleton entity = (Skeleton) world.spawnEntity(new Location(world, 0, 0, 0), EntityType.SKELETON);
        ...
        try {
            Method method = navigationAbstractClass.getDeclaredMethod("a", PathEntity.class, double.class);
