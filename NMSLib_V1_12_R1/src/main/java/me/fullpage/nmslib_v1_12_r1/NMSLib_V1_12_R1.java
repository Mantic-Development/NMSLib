package me.fullpage.nmslib_v1_12_r1;
...
public final class NMSLib_V1_12_R1 implements NMSHandler {
    ...
    public void setBlock(Block block, Material material) {
        ...
        net.minecraft.server.v1_12_R1.World nmsWorld = this.getWorld(block.getWorld());
    ...
    public void setBlock(World world, int x, int y, int z, Material material, boolean applyPhysics) {
        ...
        net.minecraft.server.v1_12_R1.World nmsWorld = this.getWorld(world);
    ...
    private IBlockData iBlockDataFromMaterial(Material m) {
        net.minecraft.server.v1_12_R1.Block nmsBlock = CraftMagicNumbers.getBlock(m);
        return nmsBlock.getBlockData();
    }

    private net.minecraft.server.v1_12_R1.World getWorld(World world) {
